# Arquitetura, decisões técnicas e tradeoffs

> Este documento complementa o [`README.md`](../README.md) (que cobre apenas como rodar, importar
> a documentação/coleção e testar a API) com o raciocínio por trás das decisões de arquitetura,
> os tradeoffs aceitos conscientemente e como o projeto ficou preparado para evoluir.
